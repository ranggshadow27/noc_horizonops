...
class TMODataPolicy
{
    ...
    {
        return $user->can('view_any_t::m::o::data');
    }
    ...
    {
        return $user->can('create_t::m::o::data');
    }
    ...
    {
        return $user->can('delete_any_t::m::o::data');
    }
    ...
    {
        return $user->can('force_delete_any_t::m::o::data');
    }
    ...
    {
        return $user->can('restore_any_t::m::o::data');
    }
    ...
    {
        return $user->can('reorder_t::m::o::data');
    }
}
